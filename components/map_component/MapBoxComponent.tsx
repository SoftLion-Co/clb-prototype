...
const MapBoxComponent = ({ onCountrySelect }) => {
  ...
  const handlePathClick = (countryId: any) => {
    const countryData = countriesData.find((c: any) => c.country === countryId);
    if (countryData) {
        ...
        >
          <g clip-path="url(#clip0_344_7219)">
            ...
            <path
              ...
              fill="#171717"
              onClick={() => handlePathClick("France")}
            />
          </g>
        </svg>
      </div>
